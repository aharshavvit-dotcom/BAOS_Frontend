...
from engines.ingestion.schema_mapping import normalize_columns
...
def load_port_calls_from_file(
    ...
    from backend.db.models.baos_models import StgPortCallRaw
    ...
    from backend.db.models.baos_models import BaosPortCall
